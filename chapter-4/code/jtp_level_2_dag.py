...
GCP_PROJECT_ID = 'jtp-gcp-data-eng'
INSTANCE_NAME = 'mysql-instance-source'
EXPORT_URI = 'gs://jtp-gcp-data-eng-data-bucket/mysql_export/from_composer/stations/stations.csv'
...
with DAG(
    ...
    bucket                              = 'jtp-gcp-data-eng-data-bucket',
